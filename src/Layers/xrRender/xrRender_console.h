...
extern ECORE_API int ps_r_ssgi;
extern ECORE_API float ps_r_ssgi_radius;
extern ECORE_API float ps_r_ssgi_strength;
...
extern ECORE_API int ps_r_water_temporal;
...
extern ECORE_API int ps_fg_parallel_record;
