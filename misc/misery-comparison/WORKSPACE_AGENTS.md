...
- Storage cleanup is complete. Current priority: prepare the user's long playtest. Further AI, shader and multicore experiments are deferred until playtest evidence justifies them. Do not repeat the completed cleanup.
