...
- Storage cleanup and long-playtest preparation are complete. Current priority: the user's manual playtest, then review its evidence. The 0.46 package has `Launch MISERY DX12 - long playtest.cmd`; see `LONG_PLAYTEST.md` there. Further AI, shader and multicore experiments are deferred until playtest evidence justifies them. Do not repeat completed cleanup, setup checks or past benchmarks without a relevant change or failure.
